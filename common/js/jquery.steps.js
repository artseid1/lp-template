...
function renderPagination(wizard, options, state)
{
    if (options.enablePagination)
    {
        var pagination = "<{0} class=\"actions {1}\"><p class=\"tiny-font col-xs-5\">"+options.legalformtxt+"</p><ul class=\"col-xs-7 btnwrap\" role=\"menu\" aria-label=\"{2}\">{3}</ul></{0}>",
            buttonTemplate = "<li><a href=\"#{0}\" class=\"btn btn-primary\" role=\"menuitem button\">{1}</a></li>",
            buttons = "";
...
var defaults = $.fn.steps.defaults = {
    /**
     * The legal text is used to pupulate the disclaimer form text.
     *
    **/
    legalformtxt: "default blank text",
    /**
